...
#         return None
    ...
    #     engine = create_engine('mssql+pyodbc://D_SERV-DBI01/SIG_LOGISTICA_DM?driver=ODBC+Driver+17+for+SQL+Server')
    #     print("✅ Conexión establecida con SQL Server")
    #     return engine
    # except pyodbc.Error as e:
    #     print("❌ Error de conexión:", e)
...
# import pyodbc
# def get_connection():
#     """ Crea y devuelve una conexión activa a SQL Server """
#     try:
#         conexion = pyodbc.connect(
#             'DRIVER={ODBC Driver 17 for SQL Server};'
#             'SERVER=D_SERV-DBI01;'
